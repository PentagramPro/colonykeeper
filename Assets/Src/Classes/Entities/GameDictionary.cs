...
public class GameDictionary  {
	...
	public List<VehicleProt> Vehicles = new List<VehicleProt>();

	[XmlIgnore]
	public Dictionary<string,VehicleProt> VehiclesByName = new Dictionary<string, VehicleProt>();
	...
	void Sort()
	{
		...
		foreach(VehicleProt v in Vehicles)
		{
